	...
	array(
		...
		'fields' => array(
			array(
				...
				'type'       => 'button_set',
				'title_info' => __( '<div class="lw-info-label">Background Type</div><div class="lw-short-content">Customize color or add video for your weather forecast background. You can also set an automated image based on weather conditions. See how it works.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-weather-details-background-type/" target="_blank">Open Docs</a><a class="lw-open-live-demo" href="https://locationweather.io/demos/weather-background-type/" target="_blank">Live Demo</a></div>', 'location-weather' ),
			...
			array(
				...
				'title_info' => __( '<div class="lw-info-label">Color Type</div><div class="lw-short-content">Choose a  color styles for customizing the appearance of your weather display. Solid provides a single color, while Gradient allows a blend of colors for a visually dynamic effect.</div>', 'location-weather' ),
				'default'    => 'solid',
			...
			array(
				...
				'title_info' => __( '<div class="lw-info-label">Weather Maximum Width (Pro)</div><div class="lw-short-content">You can customize the weather widget’s maximum width to align it with your website content area perfectly.</div><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-weather-view-maximum-width/" target="_blank">Open Docs</a>', 'location-weather' ),
			),
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'class'   => 'notice-padding',
				'content' => 'To craft your desired <a class="lw-open-live-demo" href="https://locationweather.io/demos/weather-background-type/" target="_blank">Weather View </a> with advanced customizations, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade to Pro!</strong></a>',
			),
		),
	)
);
