					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'default'    => '',
								'title_info' => __( '<div class="lw-info-label">Time Zone</div> <div class="lw-short-content">Recommended to use Default (auto-detected). If your location time is incorrect, use this option to adjust it.</div>', 'location-weather' ),
							),
							array(
								'id'         => 'lw-language',
								'type'       => 'select',
