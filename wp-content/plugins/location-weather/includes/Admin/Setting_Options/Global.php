	...
	array(
		...
		'fields' => array(
			array(
				...
				'desc'  => __( 'Strongly recommended: <a href="https://home.openweathermap.org/api_keys" target="_blank">Get your API key for free!</a> <br/>A newly created API key takes approximately 15 minutes <br/>to activate and display weather data.', 'location-weather' ),
			),
		),
	)
);
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'text_width' => '95',
				'title_info' => __( '<div class="lw-info-label">Skip Cache for Weather Update</div>By enabling this option, you can bypass caching mechanisms in certain plugins or themes, ensuring accurate and timely weather updates. Use this if you encounter caching-related issues.', 'location-weather' ),
			),
			array(
				...
				'text_off'   => __( 'Disabled', 'location-weather' ),
				'text_width' => '95',
				'title_info' => __( '<div class="lw-info-label">Cache</div>Set the duration for storing weather data, balancing freshness and server load. Shorter times provide more real-time data, while longer times reduce server requests.', 'location-weather' ),
			),
			array(
				'id'              => 'splw_cache_time',
